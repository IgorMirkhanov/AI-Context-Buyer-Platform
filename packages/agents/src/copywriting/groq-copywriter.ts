...
export type GroqCopywriterOptions = {
  apiKey: string;
  model?: string;
...
export class GroqCopywriter implements Copywriter {
  private readonly heuristic = new HeuristicCopywriter();
  private readonly options: GroqCopywriterOptions;

  constructor(options: GroqCopywriterOptions) {
